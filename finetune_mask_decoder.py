...
if __name__ == "__main__":
    ...
    parser.add_argument('--checkpoint_path', default="/mnt/qb/work/akata/aoq833/checkpoints/sam.pth")      # option that takes a value
    ...
    parser.add_argument('--num_epochs', type=int, default=10)      # option that takes a value
